export default {
  ...
  restocking: {
    title: '補充',
    description: '予算を設定し、予測から需要の不足が大きい品目に配分します',
    budgetLabel: '利用可能な予算',
    recommendations: '推奨補充品目',
    noRecommendations: 'この予算では配分できる品目がありません。予算を増やしてください。',
    allFunded: '需要が増加しているすべての予測品目に配分済みです。',
    skippedReason: '残りの予算を超過',
    totalAllocated: '配分合計',
    remainingBudget: '残りの予算',
    itemsSelected: '選択品目数',
    placeOrder: '注文する',
    placingOrder: '送信中...',
    orderSuccess: '補充注文 {orderNumber} を送信しました。注文タブで確認できます。',
